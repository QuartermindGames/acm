...
static VariableProcessor variableProcessors[] = {
        ...
        {"uint8",   ACM_PROPERTY_TYPE_UI8,           ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"uint16",  ACM_PROPERTY_TYPE_UI16,          ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"uint32",  ACM_PROPERTY_TYPE_UI32,          ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"uint",    ACM_PROPERTY_TYPE_UI32,          ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1}, // shorthand uint32
        {"uint64",  ACM_PROPERTY_TYPE_UI64,          ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"int8",    ACM_PROPERTY_TYPE_INT8,          ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"int16",   ACM_PROPERTY_TYPE_INT16,         ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"int32",   ACM_PROPERTY_TYPE_INT32,         ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
        {"int",     ACM_PROPERTY_TYPE_INT32,         ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1}, // shorthand int32
        {"int64",   ACM_PROPERTY_TYPE_INT64,         ( AcmTokenType[] ) { ACM_TOKEN_TYPE_INTEGER },                           1},
